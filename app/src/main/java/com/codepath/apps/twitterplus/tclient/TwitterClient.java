package com.codepath.apps.twitterplus.tclient;
...
public class TwitterClient extends OAuthBaseClient {
    ...
    */
    ...
    public void getMentionsTimeLine(int refreshType, long offset, AsyncHttpResponseHandler handler) {
    ...
    public void getUserTimeline(String screenName, int refreshType, long offset, AsyncHttpResponseHandler handler) {
