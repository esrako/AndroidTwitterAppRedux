...
public class TweetsArrayAdapter extends ArrayAdapter<Tweet> {
    ...
    public void setFavoritesListener(MyFavListener listener) {
        this.favlsnr = listener;
    }
    ...
    public interface MyFavListener{
        public void onFavCall(Tweet tweet);
    }
}
